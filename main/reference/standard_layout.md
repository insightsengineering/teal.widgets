...
#>         </div>
#>       </div>
#>       <aside id="bslib-sidebar-3490" class="sidebar" hidden data-resizable>
...
#>                   <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bslib-accordion-panel-7978" aria-expanded="false" aria-controls="bslib-accordion-panel-7978">
#>                     <div class="accordion-icon"></div>
#>                     <div class="accordion-title">Tests</div>
#>                   </button>
#>                 </div>
#>                 <div id="bslib-accordion-panel-7978" class="accordion-collapse collapse">
