...
#>     <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#bslib-accordion-panel-2189" aria-expanded="false" aria-controls="bslib-accordion-panel-2189">
#>       <div class="accordion-icon"></div>
#>       <div class="accordion-title">Display</div>
#>     </button>
#>   </div>
#>   <div id="bslib-accordion-panel-2189" class="accordion-collapse collapse">
