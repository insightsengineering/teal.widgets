...
test_that("{shinytest2} recording: pws1", {
  ...
  app$set_inputs(
    `plot_with_settings-plot_hover` = c(
      4.06484454951012, 2.31928839099277,
  ...
  app$set_inputs(
    `plot_with_settings-plot_hover` = c(
      4.044979056465, 3.0238102246701,
  ...
  app$set_inputs(
    `plot_with_settings-plot_hover` = c(
      2.75088408095443, 3.64026682913775,
  ...
  app$set_inputs(
    `plot_with_settings-plot_click` = c(
      2.39614313372017, 4.13563374344212,
  ...
  app$set_inputs(`plot_with_settings-plot_brush` = c(
    2.3961431337202, 3.3156316689514,
  ...
  app$set_inputs(
    `plot_with_settings-plot_hover` = c(
      3.31563166895137, 1.52670132810579,
  ...
  app$set_inputs(
    `plot_with_settings-plot_hover` = c(
      4.58986115141682, 2.71558192243627,
