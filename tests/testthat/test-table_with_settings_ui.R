...
testthat::test_that("Table with settings: UI screenshots", {
  ...
  app$expect_screenshot(threshold = 50, kernel_size = 10, delay = 0.4, name = "initial_view")
  ...
  app$expect_screenshot(threshold = 50, kernel_size = 10, delay = 0.4, name = "modal_view")
