...
5. Adding the created expression to the last chunk of a plot. `teal::calls_combine_by("+", list(...))` function could be 
...
app <- shinyApp(
  ...
  server = function(input, output, session) {
    ...
    plot_expr <- substitute(
      ...
      env = list(ggplot_expr = Reduce(x = f_ggplot2_expr, function(x, y) call("+", x, y)))
    )
